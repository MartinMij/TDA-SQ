% This script is intended to obtain a PCA and dispersion plot from Beethoven's works as described in the
...
AD=statistics('adagiob');
AL=statistics('allegrob');
AN=statistics('scherzob');
MI=statistics('minuetob');
X=[AD; AL; AN; MI];
...
legend({'Adagio','Allegro', 'Scherzo','Menuetto'})
saveas(gcf, 'results/beethoven.eps');
%%%dispersiones
...
xticks([1 2 3 4]);
xticklabels({'Minuet','Scherzo', 'Allegro','Adagio'});
saveas(gcf, 'results/beethoven-dispersion.eps');
